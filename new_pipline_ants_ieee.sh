...
parallel "time bosh exec launch --imagepath /home/niusham/projects/rrg-jbpoline/niusham/mca_linear_registration/ants_v2.5.0.sif ./ANTS.json ./{1}" ::: ./pipline/pd/invocations/ants/anat-12dofs/ieee/*
