...
if __name__ == "__main__":
    ...
    # software = "SPM"
    # failed_subjects_HC = ["sub-116230", "sub-3620",  "sub-3316",
    #   "sub-3361",  "sub-3414",  "sub-3570",  "sub-3615",  "sub-3811",  "sub-3853",  "sub-3969",  "sub-4079"]
    # failed_subjects_PD = ["sub-3403", "sub-3586", "sub-3700",
    #  "sub-3709", "sub-3823", "sub-3960", "sub-3970", "sub-4121", "sub-40733", "sub-42264", "sub-75562"]
    # path = Path().cwd() / "outputs_plots" / "diagrams" / software
    ...
    # from lnrgst_mca import load_utils
