...
# ref = Path("/home/niusham/projects/rrg-jbpoline/niusham/mca_linear_registration/tpl-MNI152NLin2009cAsym_res-01_T1w_neck_5.nii.gz")


# for group in ["hc", "pd"]:
#     in_path = Path(f"/home/niusham/projects/rrg-jbpoline/niusham/mca_linear_registration/pipline/{group}/outputs/preprocess")
#     output_dir = Path(f"./metrics_exp/{group}/output")
#     invocation_dir = Path(f"./metrics_exp/{group}/invocation")
...
for group in ["hc", "pd"]:
    ...
    invo.SPM_IEEE_registration(map_, output_path, invocation_path, ref=ref, template_name="MNI152NLin2009cAsym_res-01").create_invocations()

    invo.SPM_MCA_registration(map_, output_path, invocation_path, ref=ref, template_name="MNI152NLin2009cAsym_res-01").create_invocations()
